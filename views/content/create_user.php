...
$meta = $this->contact_model->find_meta_for($contact->id_contact,array('is_user'));
 ...
 if ($this->settings_lib->item('contact.allow_user_invite') == 1){ ?>
   ...
   <?php  if(!property_exists($meta, 'is_user')){ ?>
     <div id="collapseUser" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
     <div class="card-body">
       <?php
...
}else{ ?><div class="card-body"><?php echo lang('us_not_allowed_invites'); ?></div><?php } ?><?php } ?>
