...
<div class="row">
            <div class="col-sm-6 form-group<?php echo form_error('phone') ? ' error' : ''; ?>">
                <?php echo form_label(lang('contact_field_phone'), 'phone', array('class' => 'control-label')); ?>
                    ...
                    <input type='text' class="form-control form-control-sm phone"  id="phone" name='phone'  value="<?php echo set_value('phone', isset($contact->phone) ? $contact->phone : ''); ?>" />
            ...
            <div class="col-sm-6 form-group<?php echo form_error('phone2') ? ' error' : ''; ?>">
                <?php echo form_label(lang('contact_field_phone'), 'phone2', array('class' => 'control-label')); ?>
                    ...
                    <input type='text' class="form-control form-control-sm phone"  id="phone2" name='phone2'  value="<?php echo set_value('phone2', isset($contact->phone2) ? $contact->phone2 : ''); ?>" />
...
<div class="row">
            ...
            <div class="col-sm-6 form-group<?php echo form_error('group') ? ' error' : ''; ?>">
                <?php echo form_label(lang('contact_field_groups') . lang('bf_form_label_required'), 'group', array('class' => 'control-label')); ?>
                    ...
                    <select id='group' class="form-control form-control-sm" multiple name='group[]' >
            ...
            <select class="form-control form-control-sm tokenize" id="job_role" data-placeholder="<?php echo lang('contact_select_job_role'); ?>" name="job_role"  value="<?php echo set_value('job_role', isset($contact->job_role) ? $contact->job_role : ''); ?>">
              <option></option>
          ...
          <?php } ?>
            ...
            <select class="form-control form-control-sm" id="company" name="matriz">
              <option value="0"><?php echo lang('contact_select_company'); ?></option>
              <?php if($companies){ foreach($companies as $comp){ ?>
...
<div class="row">
              ...
              <div class="col-sm-6 form-group<?php echo form_error('city') ? ' error' : ''; ?>">
                ...
                <?php echo form_label(lang('contact_field_city') . lang('bf_form_label_required'), 'city', array('class' => 'control-label')); ?>
                      <select id='city' type='text'  class="form-control form-control-sm ad"  data-placeholder="<?php echo lang('contact_field_city'); ?>" name='city' />
                        <option></option>
