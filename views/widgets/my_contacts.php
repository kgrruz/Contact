...
<?php if($contacts){ ?>
  ...
  <?php foreach($contacts as $contact){ ?>
    ...
    <?php echo (!$this->contact_model->find_meta_for($contact->id_contact,array('lat','lng'))->lng)? anchor('contact/complete_geo/'.$contact->id_contact,'<i class="fa fa-map-marker"></i> Defina o local no mapa!'):'&nbsp;'; ?>
